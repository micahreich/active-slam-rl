...
# Copied from https://github.com/rail-berkeley/softlearning/blob/master/softlearning/environments/gym/multi_goal.py
...
class MultiGoal(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        self.timestep = 0
        return self.observation.astype(np.float32), {'pos': self.observation}
